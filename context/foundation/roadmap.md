...
| S-03 | `student-roster`              | add, view, edit, and delete students on their own roster                       | S-01          | FR-005, FR-006, FR-007, FR-008, FR-018            | done     |
...
- **Status:** done — implemented 2026-07-31. Deploy pending (Phase 5).
...
| S-03       | `student-roster`             | Teacher-scoped student roster with add / view / edit / delete         | done                  | Implemented 2026-07-31 on `10xdevs-S03`; deploy pending. Stores four identity fields, not two — PRD FR-005 / §Non-Goals amended to match. First `update` rule in the project. **Minors' data is now live — Open Roadmap Question #1 is no longer hypothetical.** |
