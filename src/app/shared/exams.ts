export const A1Exams: string[] = [
  'Cambridge STARTERS',
  'Cambridge MOVERS',
  'Cambridge FLYERS',
];

export const A2B1Exams: string[] = [
  'Cambridge A2 Key for Schools',
  'Cambridge B1 Preliminary for Schools',
];

export const B2C1Exams: string[] = [
...
export const learningRecommendations: string[] = [
  'grupowym BRITANNIA Fast Track.',
  'grupowym BRITANNIA Regular Track.',
  'grupowym BRITANNIA Support Track.',
  'indywidualnym.',
  'indywidualnym BRITANNIA Fast Track.',
  'indywidualnym BRITANNIA Regular Track.',
  'indywidualnym BRITANNIA Support Track.',
];

export const kindOfCourses: string[] = [
